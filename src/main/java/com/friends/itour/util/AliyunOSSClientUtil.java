...
import com.friends.itour.core.configurer.OSSClientConstants;
...
public class AliyunOSSClientUtil {
    ...
    public static String[] uploadObject2OSS(OSSClient ossClient, File file, String bucketName, String user_id) {
        ...
        try {
            ...
            PutObjectResult putResult = ossClient.putObject(bucketName, folder + fileName, file);
...
//        file = timefile + file.substring(file.lastIndexOf("."));
    ...
    // 测试
    public static String upload(File file, String user_id) throws Exception {
        ...
        OSSClient ossClient = AliyunOSSClientUtil.getOSSClient();
        // 上传文件
        /*String files = "C:\\Users\\79064\\Pictures\\test001.jpg";
        String[] file = files.split(",");
        String user_id = "3";*/
          ...
          //for (String filename : file) { //
              ...
              File filess = new
                      File(filename);*/
              String[] s = AliyunOSSClientUtil.uploadObject2OSS(ossClient, file, BACKET_NAME,
                              user_id);
              logger.info("上传后的文件MD5数字唯一签名:" + s[0]);
              logger.info("文件路径:"
                      + s[1]);
