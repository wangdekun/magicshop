    ...
    return (
      <div style={{ padding: '0 20px' }}>
        ...
        <Splitter orientation="vertical" className="wrapper">
          <Pane defaultSize={50} resizable collapsible>left panel</Pane>
          <Pane defaultSize={70} resizable collapsible>left panel</Pane>
          <Pane defaultSize={80} resizable collapsible>left panel</Pane>
          <Pane>
            <Splitter orientation="horizontal">
              <Pane defaultSize={100} collapsible>top panel</Pane>
              <Pane defaultSize={50} collapsible>top panel</Pane>
              <Pane>middle panel</Pane>
              <Pane defaultSize={100} collapsible>bottom panel</Pane>
              <Pane defaultSize={100} collapsible>bottom panel</Pane>
              <Pane defaultSize={50} collapsible>bottom panel</Pane>
            </Splitter>
          </Pane>
          <Pane defaultSize={50} resizable collapsible>right panel</Pane>
          <Pane defaultSize={60} resizable collapsible>right panel</Pane>
          <Pane defaultSize={80} resizable collapsible>right panel</Pane>
        </Splitter>
