...
var SelectTrigger = function (_Component) {
  ...
  SelectTrigger.prototype.processSelectedTreeNode = function processSelectedTreeNode(treeNodes) {
    ...
    // 阶层 讲平层转换为阶级数组
    var hierarchyNodes = (0, _utils.flatToHierarchy)(filterNodesPositions, true);
        ...
        (0, _toArray2["default"])(children).map(function handler(child) {
          ...
          if (child && child.props.children) {
            ...
            return _react2["default"].createElement(
              ...
              _extends({}, trProps, child.props, { pos: child.key,
                level: level, isLeft: false, key: child.key
              }),
              recursive(child.props.children, level + 1)
            );
          }
          return _react2["default"].createElement(_RightTreeNode2["default"], _extends({}, trProps, child.props, { pos: child.key,
            level: level, isLeft: true, key: child.key
          }));
        })
      );
    };
  ...
  SelectTrigger.prototype.renderRightDropdown = function renderRightDropdown(rightTreeNodes, keys) {
    var _props = this.props,
        resultsPanelAllClearBtn = _props.resultsPanelAllClearBtn,
        resultsPanelTitle = _props.resultsPanelTitle,
        resultsPanelTitleStyle = _props.resultsPanelTitleStyle,
        value = _props.value,
  ...
  SelectTrigger.prototype.render = function render() {
    ...
    var popupElement = _react2["default"].createElement(
      'div',
      { className: props.prefixCls + '-setHight' },
      _react2["default"].createElement(
        'div',
