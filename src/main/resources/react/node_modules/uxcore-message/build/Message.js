...
function notice(content) {
  ...
  var instance = multipleInstance && messageInstance ? messageInstance : createMessageInstance(options);
...
['info', 'success', 'error', 'loading', 'nw_loading'].forEach(function (item) {
