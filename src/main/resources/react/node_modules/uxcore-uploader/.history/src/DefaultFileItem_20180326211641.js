  ...
  render() {
    ...
    if (mode === 'icon') {
      ...
      if (isOnlyImg) {
        if (!isVisual) {
          return (<div className={readOnlyStyle}>
            <div className="field-image-info">
              <a className="field-image-preview" onClick={me.onShowFile.bind(this, file, previewUrl)} href={previewUrl} target="_blank">
                <img src={previewUrl} />
              </a>
            </div>
        ...
        return (<div className={readOnlyStyle}>
          <div className="field-image-info">
            <a className="field-image-preview" onClick={me.onShowFile.bind(this, file, previewUrl)} href={previewUrl}>
              <img src={previewUrl} />
            </a>
          </div>
          <div className="field-status">
