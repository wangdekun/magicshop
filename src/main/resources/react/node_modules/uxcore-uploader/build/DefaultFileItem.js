...
var DefaultFileItem = function (_React$Component) {
  ...
  DefaultFileItem.prototype.render = function render() {
    ...
    if (isOnlyImg) {
      var type = isVisual ? 'kuma-upload-fileitem-visual' : 'kuma-upload-fileitem-img';
    ...
    if (mode === 'icon') {
      return _react2["default"].createElement(
        ...
        _react2["default"].createElement(
          'a',
          { className: 'kuma-upload-action remove-action', onClick: this.onCancel.bind(this), title: _locale2["default"][locale].remove },
          ...
          return _react2["default"].createElement(
            ...
            _react2["default"].createElement(
              ...
              previewUrl ? _react2["default"].createElement(
                'a',
                { className: 'kuma-upload-action preview-action', onClick: me.onShowFile.bind(this, file, previewUrl), target: '_blank', href: previewUrl },
                _react2["default"].createElement(_uxcoreIcon2["default"], { name: 'fangda' })
              ) : null,
              downloadUrl && !readOnly ? _react2["default"].createElement(
                'a',
              ...
              response.canRemove !== false && !readOnly ? _react2["default"].createElement(
                'a',
                { className: 'kuma-upload-action remove-action', onClick: this.onCancel.bind(this, file) },
                _react2["default"].createElement(_uxcoreIcon2["default"], { name: 'shanchu' })
              ) : undefined
            )
          );
      ...
      return _react2["default"].createElement(
        ...
        _react2["default"].createElement(
          ...
          _react2["default"].createElement('i', { className: 'kuma-upload-fileicon', 'data-ext': file.ext, 'data-type': file.fileType })
        ),
    ...
    return _react2["default"].createElement(
      ...
      _react2["default"].createElement(
        ...
        !readOnly ? _react2["default"].createElement(
          'a',
          { className: 'kuma-upload-action remove-action', onClick: this.onCancel.bind(this, file), title: _locale2["default"][locale].remove },
          _react2["default"].createElement(_uxcoreIcon2["default"], { name: 'shanchu' })
        ) : null
      )
    );
