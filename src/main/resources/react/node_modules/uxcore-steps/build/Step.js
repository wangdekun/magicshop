    ...
    if (type === 'arrow-bar') {
      ...
      if (description) {
        ...
        descJsx = _react2["default"].createElement(
          ...
          _react2["default"].createElement(_uxcoreIcon2["default"], { name: 'xinxitishicopy', className: 'step-info' })
        );
      }
    ...
    if (showIcon) {
      ...
      if (icon) {
        ...
        iconJsx = _react2["default"].createElement(
          'span',
          { className: prefixCls + '-icon' },
          _react2["default"].createElement(_uxcoreIcon2["default"], { name: 'option-yixuan-gou' })
        );
      } else if (status === 'error') {
        iconJsx = _react2["default"].createElement(
          'span',
          { className: prefixCls + '-icon' },
          _react2["default"].createElement(_uxcoreIcon2["default"], { name: 'biaoqian-qingchu' })
        );
      }
    }
