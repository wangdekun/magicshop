...
<html lang="en">
<head>
    <title>Code coverage report for src/RcDialog.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> RcDialog.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (document) {
      ...
      _this._container = getContainer ? <span class="branch-0 cbranch-no" title="branch not covered" >getContainer() </span>: defaultGetContainer();
