...
<html lang="en">
<head>
    <title>Code coverage report for src/Dialog.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> Dialog.jsx
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">58.93% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>33/56</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>90/99</span>
      </div>
    </div>
  </div>
...
&nbsp;
var _extends = Object.assign || function (target) { for (var i = 1; i &lt; arguments.length; i++) { var source = arguments[i]; for (var key in source) { <span class="missing-if-branch" title="else path not taken" >E</span>if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return parseInt(ua.substring(idx + 5, ua.indexOf('.', idx)), 10);</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (ua.match(/Trident\/7\./)) {
...
&nbsp;
    ...
    if (htmlClassName) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (nextProps.visible) {
<span class="cstat-no" title="statement not covered" >        if (supportClassList) {</span>
<span class="cstat-no" title="statement not covered" >          htmlNode.classList.add(htmlClassName);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          htmlNode.className += ' ' + htmlClassName;</span>
        }
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (supportClassList) {
        htmlNode.classList.remove(htmlClassName);
      } else {
<span class="cstat-no" title="statement not covered" >        var cls = htmlNode.className;</span>
<span class="cstat-no" title="statement not covered" >        cls = cls.replace(new RegExp('\\s?' + htmlClassName), '');</span>
<span class="cstat-no" title="statement not covered" >        htmlNode.className = cls;</span>
      }
    }
  };
&nbsp;
...
function adjustIcon(props, defaultIcon) {
  var icon = props.iconClassName ? <span class="branch-0 cbranch-no" title="branch not covered" >_react2['default'].createElement(_uxcoreIcon2['default'], { name: props.iconClassName }) </span>: _react2['default'].createElement(_uxcoreIcon2['default'], { name: defaultIcon });
  return props.icon ? <span class="branch-0 cbranch-no" title="branch not covered" >props.icon </span>: icon;
}
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Apr 23 2018 15:22:27 GMT+0800 (CST)
</div>
</div>
