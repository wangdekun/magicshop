...
<html lang="en">
<head>
    <title>Code coverage report for src/confirm.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> confirm.jsx
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">89.19% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>66/74</span>
      </div>
      <div class='fl pad1y space-right2'>
...
exports['default'] = function () {
  var props = arguments.length &gt; 0 &amp;&amp; arguments[0] !== undefined ? arguments[0] : <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
...
&nbsp;
  function close() {
    if (newProps.htmlClassName) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (supportClassList) {
        htmlNode.classList.remove(newProps.htmlClassName);
      } else {
<span class="cstat-no" title="statement not covered" >        htmlNode.className = htmlNode.className.replace(new RegExp('\\s?' + newProps.htmlClassName), '');</span>
      }
    }
    _reactDom2['default'].unmountComponentAtNode(div);
    <span class="missing-if-branch" title="else path not taken" >E</span>if (document.body.contains(div)) {
...
&nbsp;
  function onCancel() {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (cancelFn) {
      var ret = void 0;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (cancelFn.length) {
<span class="cstat-no" title="statement not covered" >        ret = cancelFn(close);</span>
      } else {
        ret = cancelFn();
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (ret &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >ret.then)</span> {
<span class="cstat-no" title="statement not covered" >        ret.then(close);</span>
      }
    } else {
...
&nbsp;
  function onOk() {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (okFn) {
      var ret = void 0;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (okFn.length) {
<span class="cstat-no" title="statement not covered" >        ret = okFn(close);</span>
      } else {
        ret = okFn();
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!ret) {
          close();
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (newProps.icon) {
    icon = newProps.icon;
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      htmlNode.className += ' ' + newProps.htmlClassName;</span>
    }
  }
&nbsp;
