...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> util.js
    </h1>
    <div class='clearfix'>
...
exports['default'] = {
  ...
  getSubTotal: function getSubTotal(arr) {
    var start = arguments.length &gt; 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
    var end = arguments[2];
&nbsp;
    ...
    console.log(arr);
    var length = (end === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >arr.length </span>: end) - start;
    var total = 0;
    for (var _i = 0; _i &lt; length; _i += 1) {
      total += arr[start + _i] || <span class="branch-1 cbranch-no" title="branch not covered" >arr[0];</span>
    }
    return total;
  },
&nbsp;
&nbsp;
  ...
  getLargestArr: function getLargestArr() {
    var arr = arguments.length &gt; 0 &amp;&amp; arguments[0] !== undefined ? arguments[0] : <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
&nbsp;
    var largest = [];
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!arr) {
<span class="cstat-no" title="statement not covered" >      return largest;</span>
    }
&nbsp;
