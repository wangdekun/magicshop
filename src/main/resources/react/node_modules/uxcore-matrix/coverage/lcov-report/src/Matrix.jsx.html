...
<html lang="en">
<head>
    <title>Code coverage report for src/Matrix.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> Matrix.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
    _this.data = (0, _deepcopy2['default'])(props.data);
    _this.state = {
      vm: _this.getVirtualMatrix(_this.data)
    };
    return _this;
  }
&nbsp;
  Matrix.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    var newState = {};
    var vmNeedUpdate = false;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!(0, _deepEqual2['default'])(this.data, nextProps.data)) {
      this.data = (0, _deepcopy2['default'])(nextProps.data);
      vmNeedUpdate = true;
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (vmNeedUpdate) {
...
&nbsp;
  Matrix.prototype.getVirtualMatrix = function getVirtualMatrix(data) {
    if (data &amp;&amp; data.data) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Oct 18 2017 13:47:39 GMT+0800 (CST)
</div>
</div>
