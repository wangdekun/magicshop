...
var InputEditor = function (_BaseEditor) {
  ...
  InputEditor.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
  ...
  InputEditor.prototype.insertContentAtCaret = function insertContentAtCaret(text) {
    ...
    if (document.selection) {
      ...
      value = value.substring(0, this.selectionPosition.start) + text + value.substring(this.selectionPosition.end, editor.value.length);
      this.setState({
        value: value
      }, function () {
        editor.focus();
  ...
  InputEditor.prototype.handleChange = function handleChange(e) {
    this.setState({
