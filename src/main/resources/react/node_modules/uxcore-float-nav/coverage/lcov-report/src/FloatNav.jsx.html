...
<html lang="en">
<head>
    <title>Code coverage report for src/FloatNav.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> FloatNav.jsx
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">91.16% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>165/181</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>150/162</span>
      </div>
    </div>
  </div>
...
395
396
397</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
function _defaults(obj, defaults) { var keys = Object.getOwnPropertyNames(defaults); for (var i = 0; i &lt; keys.length; i++) { var key = keys[i]; var value = Object.getOwnPropertyDescriptor(defaults, key); <span class="missing-if-branch" title="if path not taken" >I</span>if (value &amp;&amp; value.configurable &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >obj[key] === undefined)</span> { <span class="cstat-no" title="statement not covered" >Object.defineProperty(obj, key, value); </span>} } return obj; }
&nbsp;
...
&nbsp;
  FloatNav.prototype.componentWillReceiveProps = <span class="fstat-no" title="function not covered" >function componentWillReceiveProps(nextProps) {</span>
...
&nbsp;
  FloatNav.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (prevProps.height !== this.props.height) {
<span class="cstat-no" title="statement not covered" >      this.updateComponentHeight();</span>
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.activeItem) {
      this.updateScroll();
    }
  };
&nbsp;
    ...
    if (children) {
      if (!children.length) {
        ...
        _react2['default'].Children.forEach(children, function (child) {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (childAnchor) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (trigger !== 'scroll') return;
<span class="cstat-no" title="statement not covered" >    var containerRect = this.containerEle.getBoundingClientRect();</span>
<span class="cstat-no" title="statement not covered" >    var activeRect = this.activeItem.getBoundingClientRect();</span>
<span class="cstat-no" title="statement not covered" >    var delta = activeRect.top - containerRect.top;</span>
<span class="cstat-no" title="statement not covered" >    if (delta &lt; 0) {</span>
<span class="cstat-no" title="statement not covered" >      this.handleScrollUp();</span>
    } else <span class="cstat-no" title="statement not covered" >if (delta &gt; this.viewHeight) {</span>
<span class="cstat-no" title="statement not covered" >      this.handleScrollDown();</span>
    }
  };
&nbsp;
  FloatNav.prototype.centerActive = function centerActive() {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (delta / this.viewHeight &lt; 1 / 3) {
<span class="cstat-no" title="statement not covered" >      this.handleScrollUp();</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (delta / this.viewHeight &gt; 2 / 3) {
<span class="cstat-no" title="statement not covered" >      this.handleScrollDown();</span>
    }
  };
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (scrollTop &lt;= 0) {
      scrollTop = 0;
    }
    (0, _objectAssign2['default'])(state, {
      scrollTop: scrollTop
...
&nbsp;
    scrollTop += stepLength;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (scrollTop &gt;= this.maxScrollHeight) {
...
&nbsp;
    ...
    anchors.some(function (anchor) {
      anchorNode = _this3.wrapper.querySelector('#' + anchor);
      <span class="missing-if-branch" title="else path not taken" >E</span>if (anchorNode) {
        rect = anchorNode.getBoundingClientRect();
        rect = _this3.wrapper.querySelector('#' + anchor).getBoundingClientRect();
        activeAnchor = anchor;
        return rect.top &gt; 0;
      }
<span class="cstat-no" title="statement not covered" >      return false;</span>
    });
    <span class="missing-if-branch" title="else path not taken" >E</span>if (activeAnchor) {
      this.setState({
...
&nbsp;
    ...
    return _react2['default'].Children.map(children, function (item, index) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (showOrderNumber) {
...
&nbsp;
  FloatNav.prototype.renderContent = function renderContent() {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Jan 08 2018 13:41:18 GMT+0800 (CST)
</div>
</div>
