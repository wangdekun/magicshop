...
<html lang="en">
<head>
    <title>Code coverage report for src/NavItem.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> NavItem.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  NavItem.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!anchor) {
...
&nbsp;
  NavItem.prototype.renderSubNav = function renderSubNav() {
    var _props2 = this.props,
        prefixCls = _props2.prefixCls,
        children = _props2.children,
        orderNumber = _props2.orderNumber,
        onActive = _props2.onActive,
        subActiveAnchor = _props2.subActiveAnchor,
        level = _props2.level;
&nbsp;
...
&nbsp;
    return _react2['default'].createElement(
      'div',
      { className: (0, _classnames4['default'])(prefixCls + '-subs') },
      _react2['default'].Children.map(children, function (item, index) {
        itemProps = (0, _objectAssign2['default'])({
          onActive: onActive,
          active: item.props.anchor &amp;&amp; subActiveAnchor === item.props.anchor,
          subActiveAnchor: subActiveAnchor,
          level: level + 1
        }, cloneProps);
        <span class="missing-if-branch" title="else path not taken" >E</span>if (orderNumber) {
...
&nbsp;
  NavItem.prototype.renderCircleIcon = function renderCircleIcon() {
...
&nbsp;
    if (rootNode &amp;&amp; !active) {
      return _react2['default'].createElement(
        'svg',
        { width: '20', height: '20' },
        _react2['default'].createElement('circle', { cx: '10', cy: '10', r: '3', className: 'item-circle-icon' })
      );
    }
    return null;
  };
&nbsp;
  NavItem.prototype.renderArrowIcon = function renderArrowIcon() {
...
&nbsp;
    var _props4 = this.props,
        ...
        title = _props4.title,
        orderNumber = _props4.orderNumber,
...
&nbsp;
    return _react2['default'].createElement(
      'div',
      {
        className: (0, _classnames4['default'])(prefixCls + '-item', _defineProperty({}, prefixCls + '-item-active', active)), ref: function ref(node) {
      ...
      _react2['default'].createElement(
        'a',
        {
          className: (0, _classnames4['default'])(prefixCls + '-item-title', _defineProperty({}, prefixCls + '-item-title-active', active)),
          style: {
        ...
        _react2['default'].createElement(
          'span',
          { className: prefixCls + '-item-title-inner' },
          orderNumber,
          ' ',
          title
        )
...
NavItem.defaultProps = {
  ...
  onActive: <span class="fstat-no" title="function not covered" >function onActive() {</span>},
  rootNode: true,
  active: false,
  subActiveAnchor: ''
};
NavItem.propTypes = {
  ...
  orderNumber: _propTypes2['default'].string,
  anchor: _propTypes2['default'].string,
  onClick: _propTypes2['default'].func,
  onActive: _propTypes2['default'].func,
  rootNode: _propTypes2['default'].bool,
  active: _propTypes2['default'].bool,
  subActiveAnchor: _propTypes2['default'].string,
